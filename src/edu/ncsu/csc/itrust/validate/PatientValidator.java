...
public class PatientValidator extends BeanValidator<PatientBean> {
	...
	public void validate(PatientBean p) throws FormValidationException {
		...
		System.out.println("Mother MID is: " + p.getMotherMID());
		System.out.println("checkFormat(\"Mother MID\", p.getMotherMID(), ValidationFormat.NON_STAFF_MID, true) is: " + checkFormat("Mother MID", p.getMotherMID(), ValidationFormat.NON_STAFF_MID, true));
		errorList.addIfNotNull(checkFormat("Mother MID", p.getMotherMID(), ValidationFormat.NON_STAFF_MID, true));
		errorList.addIfNotNull(checkFormat("Father MID", p.getFatherMID(), ValidationFormat.NON_STAFF_MID, true));
		errorList
		...
		System.out.println("errorList.hasErrors() is: " + errorList.hasErrors());
		if (errorList.hasErrors()){
			System.out.println("Throwing FormValidationException");
