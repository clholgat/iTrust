...
public class ViewDiagnosisStatisticsAction {
	 ...
	 * @throws DBException
	 */
	public ArrayList<DiagnosisStatisticsBean> getEpidemicStatistics(String startDate, String icdCode, String zip, String thresholdStr) throws FormValidationException, DBException {
		...
		try{
			Integer.parseInt(thresholdStr);//Going to throw this away, just used to check fi it will throw an error
		}catch(NumberFormatException e){
			throw new FormValidationException("Please enter a threshold");
		}
	...
	public boolean isFluEpidemic(String curDateStr, String zip) throws ParseException, DBException {
		...
		double weekNow = dbNow.getRegionStats();
		double weekL = dbLast.getRegionStats();
		double weekN = dbNext.getRegionStats();
	 ...
	 * @throws FormValidationException 
	 */
	public boolean isMalariaEpidemic(String weekDate, String zip, String thresholdStr) throws DBException, ParseException, FormValidationException {
		...
		int threshold = Integer.parseInt(thresholdStr);//This is throwing bug 4		
