...
public class DrugInteractionTest extends iTrustHTTPTest {
	...
	public void testRecordDrugInteraction() throws Exception {
		...
		intForm.getScriptableObject().setParameterValue("drug1", "61958-0501 Adefovir");
		intForm.getScriptableObject().setParameterValue("drug2", "08109-6 Aspirin");
	...
	public void testRecordDrugInteractionSameDrugs() throws Exception {
		...
		WebForm intForm = wr.getForms()[0];
		intForm.getScriptableObject().setParameterValue("drug1", "61958-0501 Adefovir");
		intForm.getScriptableObject().setParameterValue("drug2", "61958-0501 Adefovir");
