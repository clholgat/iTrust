...
public class ViewPatientsUseCaseTest extends iTrustHTTPTest {
	...
	public void testViewLHCPPatients() throws Exception{
		...
		assertEquals("10/31/2010", wt.getTableCell(5,2).getText());
		assertEquals("10/31/2010", wt.getTableCell(6,2).getText());
		assertEquals("06/10/2007", wt.getTableCell(7,2).getText());
		assertEquals("05/10/2006", wt.getTableCell(8,2).getText());
		assertEquals("05/10/2006", wt.getTableCell(9,2).getText());
		assertEquals("10/10/2005", wt.getTableCell(10,2).getText());
		assertEquals("10/10/2005", wt.getTableCell(11,2).getText());
		assertEquals("344 Bob Street Raleigh NC 27607", wt.getTableCell(7,1).getText());
