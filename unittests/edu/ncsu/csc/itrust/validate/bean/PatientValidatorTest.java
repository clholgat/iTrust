...
public class PatientValidatorTest extends TestCase {
	...
	public void testPatientAllErrors() throws Exception {
		...
		try {
			...
			assertEquals("Mother MID: " + ValidationFormat.NON_STAFF_MID.getDescription(), e.getErrorList().get(23));
			assertEquals("Father MID: " + ValidationFormat.NON_STAFF_MID.getDescription(), e.getErrorList().get(24));
