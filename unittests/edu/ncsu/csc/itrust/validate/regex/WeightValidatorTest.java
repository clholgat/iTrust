...
public class WeightValidatorTest extends TestCase{
	private ValidatorProxy validatorProxy = new ValidatorProxy();
	private static final ValidationFormat VALIDATION_FORMAT = ValidationFormat.Weight;
	private static final String PASSED = "";
	private static final String FAILED = "Weight: " + VALIDATION_FORMAT.getDescription();

	public void testDecimalZero() throws Exception {//Fails
		String value = "0.0";
		String errorMessage = FAILED;
		assertEquals(errorMessage, validatorProxy.checkFormat("Weight", value, VALIDATION_FORMAT, false));
	}
